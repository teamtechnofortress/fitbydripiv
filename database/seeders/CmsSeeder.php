...
class CmsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // --- Categories (matching React initial schema) ---
        $weightLoss = CmsCategory::updateOrCreate(['slug' => 'weight-loss'], [
            'name' => 'Weight Loss',
        ...
        $wellness = CmsCategory::updateOrCreate(['slug' => 'wellness'], [
            'name' => 'Wellness',
        ...
        $longevity = CmsCategory::updateOrCreate(['slug' => 'longevity'], [
            'name' => 'Longevity',
        ...
        $semaglutide = CmsProduct::updateOrCreate(['slug' => 'semaglutide'], [
            ...
            'treatment_details' => [
                ...
                'ingredients' => ['Semaglutide (GLP-1 receptor agonist)', 'Compounded pharmaceutical grade'],
                'duration' => 'Results typically seen within 2-4 weeks of starting therapy. Significant weight loss develops over 3-6 months. Treatment duration varies based on individual goals, response, and health markers. Continuous medical oversight throughout.',
                'usage' => 'Administered as a once-weekly subcutaneous injection (under the skin). Dosage is gradually increased under medical supervision to optimize results and minimize side effects. Our team provides complete injection training and ongoing support.',
            ],
            'featured_image' => '/images/simagulatide.png',
            'base_price' => 140.00,
            'micro_dose_price' => 122.50,
            'sample_price' => 59.50,
            'display_order' => 1,
            'is_featured' => true,
        ]);

        $tirzepatide = CmsProduct::updateOrCreate(['slug' => 'tirzepatide'], [
            'category_id' => $weightLoss->id,
            'name' => 'Tirzepatide',
            'short_description' => 'A High Percentage of Tirzepatide Patients Are Seeing Healthier Swiss Being Prescription Weight Loss Therapy Results.',
            'full_description' => "Healthier SWIMM BEING Prescription Weight Loss Therapy - utilizing compounded Tirzepatide for your weight loss goals AND improved metabolic health. Patients report significant weight loss results, increased energy, improved physical health, enhanced confidence of appearance, and better overall wellbeing. This dual-action medication activates both GIP and GLP-1 receptors for superior results. Complete our Telehealth intake about your Health and Goals, and our medical provider will review for eligibility.",
            'benefits' => [
            ...
            'treatment_details' => [
                ...
                'ingredients' => ['Tirzepatide (GIP and GLP-1 receptor agonist)', 'Compounded pharmaceutical grade'],
                'duration' => 'Initial results within 2-4 weeks. Significant weight loss develops over 3-6 months of treatment. Optimal effects achieved with consistent use and lifestyle modifications. Treatment duration personalized to individual goals and response.',
                'usage' => 'Administered as once-weekly subcutaneous injection. Gradual dose escalation under medical supervision to optimize results and tolerance. Complete injection training provided. Continuous support throughout your journey.',
            ],
            'featured_image' => '/images/Tirziptide+b12.png',
            'base_price' => 150.00,
            'micro_dose_price' => 131.25,
            'sample_price' => 63.75,
            'display_order' => 2,
            'is_featured' => true,
        ]);

        $b12 = CmsProduct::updateOrCreate(['slug' => 'b12-injection'], [
            'category_id' => $wellness->id,
            'name' => 'B12 (Methylcobalamin)',
            'short_description' => 'Boost Energy, Enhance Metabolism, and Support Nervous System Health',
            'full_description' => "Vitamin B12 (Methylcobalamin) is an essential nutrient that plays a crucial role in energy production, red blood cell formation, DNA synthesis, and neurological function. As we age or face dietary restrictions, B12 deficiency becomes increasingly common, leading to fatigue, cognitive decline, and metabolic issues. Our pharmaceutical-grade B12 injections bypass digestive limitations, delivering this vital nutrient directly into your system for maximum absorption and immediate benefits. Unlike oral supplements that lose potency during digestion, injectable B12 provides 100% bioavailability, ensuring your body receives the full therapeutic dose. Regular B12 supplementation supports healthy energy levels, mental clarity, cardiovascular health, and overall vitality.",
            'benefits' => [
            ...
            'treatment_details' => [
                ...
                'ingredients' => ['Methylcobalamin (Vitamin B12)', 'Sterile Water for Injection', 'Preservatives (Benzyl Alcohol)'],
                'duration' => 'Most patients notice increased energy within 24-48 hours after their first injection. Optimal benefits accumulate over 4-8 weeks with regular administration. Monthly maintenance injections help sustain therapeutic B12 levels and prevent deficiency symptoms from returning.',
                'usage' => 'B12 injections are typically administered intramuscularly (IM) into the deltoid or gluteal muscle. Initial therapy may involve weekly injections for 4-6 weeks to build adequate stores, followed by monthly maintenance injections. Dosing is customized based on your B12 levels, symptoms, and health goals. Our medical team will provide detailed injection instructions and ongoing support throughout your treatment.',
            ],
            'featured_image' => '/images/B12.png',
            'base_price' => 35.00,
            'display_order' => 1,
            'is_featured' => true,
        ]);

        $glutathione = CmsProduct::updateOrCreate(['slug' => 'glutathione'], [
            'category_id' => $wellness->id,
            'name' => 'Glutathione',
            'short_description' => 'Boost Your Immunity, Improve Energy, Tone and Detox. Plays a prime role in protecting the body and every cell.',
            'full_description' => "Glutathione is manually found in every cell in the human body and is your body's master antioxidant. Plays a prime role in protecting the body against oxidative stress and supporting energy production AND detoxification. Glutathione supports energy production, detoxification, and overall cellular health. NAD+ is also crucial for cellular health, working together with glutathione. Our therapy bypasses limitations of oral supplementation through advanced delivery methods via subcutaneous injection for maximum bioavailability and effectiveness.",
            'benefits' => [
            ...
            'treatment_details' => [
                ...
                'ingredients' => ['Glutathione (reduced form - master antioxidant)', 'Supporting cofactors for optimal absorption', 'Bioavailable formulation'],
                'duration' => 'Benefits may be noticed within 2-4 weeks of consistent treatment. Optimal results typically seen over 2-3 months of regular therapy. Long-term cellular benefits continue to build.',
                'usage' => 'Available in Subcutaneous injection for maximum bioavailability and effectiveness. Treatment frequency and method personalized based on your needs, goals, and lifestyle preferences.',
            ],
            'featured_image' => '/images/Glutathione.png',
            'base_price' => 149.00,
            'display_order' => 2,
            'is_featured' => true,
        ]);

        $nad = CmsProduct::updateOrCreate(['slug' => 'nad-therapy'], [
            'category_id' => $longevity->id,
            'name' => 'NAD+ Therapy',
            'short_description' => 'Aging Repair Your Own Boost. NAD+ (Nicotinamide Adenine Dinucleotide) is naturally found in every cell and diminishes with age.',
            'full_description' => "NAD+ is an acronym for Nicotinamide Adenine Dinucleotide - a vital coenzyme naturally found in every cell in the human body. Diminishing levels of NAD+ may assist in hyperness (aging decline). Our NAD+ therapy helps replenish these critical levels through advanced delivery methods that bypass oral limitations. Available via Subcutaneous injection for optimal cellular absorption. Support energy production, mental clarity, and anti-aging at the cellular level.",
            'benefits' => [
            ...
            'treatment_details' => [
                ...
                'ingredients' => ['NAD+ (Nicotinamide Adenine Dinucleotide)', 'Supporting vitamins and cofactors', 'Bioavailable formulation'],
                'duration' => 'Energy effects may be felt during or immediately after treatment. Long-term cellular benefits and anti-aging effects develop over 4-8 weeks of consistent therapy. Many patients report sustained improvements in energy and mental clarity.',
                'usage' => 'Available in the most effective delivery form via Subcutaneous injection for high bioavailability. Treatment frequency personalized to your individual needs, goals, and lifestyle. Our medical team will provide your best option based on your telehealth information provided.',
            ],
            'featured_image' => '/images/NAD +.png',
            'base_price' => 199.00,
            'display_order' => 1,
            'is_featured' => true,
        ]);

        // --- Delete old product slugs that changed ---
        CmsProduct::where('slug', 'tirzepatide-b12')->delete();
        CmsProduct::where('slug', 'b12')->delete();
        CmsProduct::where('slug', 'nad-plus')->delete();

        // --- Subscription Discounts ---
        $productsWithPricing = [$semaglutide, $tirzepatide, $b12, $glutathione, $nad];
        foreach ($productsWithPricing as $product) {
            CmsSubscriptionDiscount::updateOrCreate(
                ['product_id' => $product->id, 'frequency_months' => 1],
                ['discount_percentage' => 10]
            );
            CmsSubscriptionDiscount::updateOrCreate(
                ['product_id' => $product->id, 'frequency_months' => 2],
                ['discount_percentage' => 12]
            );
            CmsSubscriptionDiscount::updateOrCreate(
                ['product_id' => $product->id, 'frequency_months' => 3],
                ['discount_percentage' => 15]
            );
        }

        // --- B12 Pricing Options ---
        CmsPricingOption::where('product_id', $b12->id)->delete();
        CmsPricingOption::create([
            'product_id' => $b12->id,
            'plan_name' => 'Single Injection',
            'price' => 35,
            'billing_cycle' => 'one-time',
            'supply_duration' => '1 injection',
            'description' => 'Perfect for first-time users or occasional energy boost',
            'features' => ['1 B12 (Methylcobalamin) injection', 'Medical consultation included', 'Self-administration instructions', 'Immediate energy benefits', 'No commitment required'],
            'is_popular' => false,
            'display_order' => 1,
        ]);
        CmsPricingOption::create([
            'product_id' => $b12->id,
            'plan_name' => '1-Month Supply',
            'price' => 85,
            'billing_cycle' => 'monthly',
            'supply_duration' => '4 injections',
            'description' => 'Ideal for maintaining optimal B12 levels',
            'features' => ['4 B12 injections (1 per week)', 'Build healthy B12 stores', 'Sustained energy support', 'Medical oversight included', 'Flexible delivery schedule'],
            'is_popular' => true,
            'display_order' => 2,
        ]);
        CmsPricingOption::create([
            'product_id' => $b12->id,
            'plan_name' => '3-Month Wellness Plan',
            'price' => 225,
            'billing_cycle' => 'quarterly',
            'supply_duration' => '12 injections',
            'description' => 'Best value for long-term health optimization',
            'features' => ['12 B12 injections (1 per week)', 'Save $30 vs monthly plan', 'Comprehensive wellness support', 'Priority medical support', 'Convenient quarterly delivery', 'Maximum therapeutic benefit'],
            'is_popular' => false,
            'display_order' => 3,
        ]);

        // --- Research Links ---
        $this->seedResearchLinks($semaglutide, $tirzepatide, $b12, $glutathione, $nad);

        // --- Product FAQs ---
        $this->seedProductFaqs($semaglutide, $tirzepatide, $b12, $glutathione, $nad);

        // --- General FAQs ---
        $this->seedGeneralFaqs();
    }

    private function seedResearchLinks($semaglutide, $tirzepatide, $b12, $glutathione, $nad): void
    {
        // Semaglutide
        $this->createResearchLinks($semaglutide->id, [
            ['title' => 'ScienceDirect: GLP-1 Receptor Agonist Mechanisms', 'authors' => 'Various Authors', 'journal' => 'ScienceDirect', 'publication_year' => 2024, 'article_url' => 'https://www.sciencedirect.com/science/article/pii/s221324220038'],
            ['title' => 'NIH Gov/Articles: GLP-1 Treatment Efficacy', 'authors' => 'Various Authors', 'journal' => 'NIH Gov/Articles', 'publication_year' => 2024, 'pubmed_id' => 'Pmc 8947838', 'article_url' => 'https://pmc.ncbi.nlm.nih.gov/articles/pmc8947838'],
            ['title' => 'PubMed: Semaglutide for Weight Management', 'authors' => 'Various Authors', 'journal' => 'PubMed NCBI', 'publication_year' => 2024, 'pubmed_id' => 'Pmc 9418657', 'article_url' => 'https://pubmed.ncbi.nlm.nih.gov/'],
        ]);

        // Tirzepatide
        $this->createResearchLinks($tirzepatide->id, [
            ['title' => 'GLP-1 Receptor Agonists: Central Nervous System Effects on Energy Balance', 'authors' => 'Various Authors', 'journal' => 'ScienceDirect', 'publication_year' => 2024, 'article_url' => 'https://www.sciencedirect.com/science/article/pii/S221324220038'],
            ['title' => 'GLP-1 and GIP Receptor Dual Agonist Treatment Effects', 'authors' => 'Various Authors', 'journal' => 'NIH Gov/Articles', 'publication_year' => 2024, 'pubmed_id' => 'Pmc 9418649', 'article_url' => 'https://pmc.ncbi.nlm.nih.gov/articles/pmc9418649'],
            ['title' => 'Dual GIP/GLP-1 Receptor Co-Agonist for Weight Management', 'authors' => 'Various Authors', 'journal' => 'PubMed', 'publication_year' => 2024, 'pubmed_id' => 'Pmc 9418657', 'article_url' => 'https://pubmed.ncbi.nlm.nih.gov/articles/'],
            ['title' => 'Full Clinical Trial Results for Tirzepatide in Weight Loss', 'authors' => 'Various Authors', 'journal' => 'JAMA Internal Medicine', 'publication_year' => 2024, 'article_url' => 'https://jamanetwork.com/journals/jamainternalmedicine/fullarticle/2802038'],
            ['title' => 'Mechanisms and Clinical Efficacy of Dual GIP/GLP-1 Therapy', 'authors' => 'Various Authors', 'journal' => 'Mayo Clinic Drug Supplements', 'publication_year' => 2024, 'article_url' => 'https://mayoclinic.org/drugs-supplements/tirzepatide/description/drg-20534047'],
        ]);

        // B12
        $this->createResearchLinks($b12->id, [
            ['title' => 'Vitamin B12 Deficiency: Recognition and Management', 'authors' => 'Langan RC, Goodbred AJ', 'journal' => 'American Family Physician', 'publication_year' => 2017, 'pubmed_id' => '28671426', 'article_url' => 'https://pubmed.ncbi.nlm.nih.gov/28671426/'],
            ['title' => 'The Role of Vitamin B12 in Energy Metabolism', 'authors' => 'Kennedy DO', 'journal' => 'Nutrients', 'publication_year' => 2016, 'pubmed_id' => '27338459', 'doi' => '10.3390/nu8070394', 'article_url' => 'https://pubmed.ncbi.nlm.nih.gov/27338459/'],
            ['title' => 'Methylcobalamin: A Potential Vitamin for Chronic Pain', 'authors' => 'Zhang Y, Sun C, Zhang X', 'journal' => 'Neural Regeneration Research', 'publication_year' => 2013, 'article_url' => 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4146230/'],
            ['title' => 'Vitamin B12 and Cognition in Older Adults', 'authors' => 'Moore K, Hughes CF, Ward M', 'journal' => 'Mayo Clinic Proceedings', 'publication_year' => 2021, 'pubmed_id' => '33840514', 'doi' => '10.1016/j.mayocp.2020.12.032', 'article_url' => 'https://pubmed.ncbi.nlm.nih.gov/33840514/'],
            ['title' => 'Intramuscular vs Oral Vitamin B12: A Bioavailability Study', 'authors' => 'Andrès E, Serraj K, Zhu J', 'journal' => 'BMJ Case Reports', 'publication_year' => 2013, 'doi' => '10.1136/bcr-2012-007755', 'article_url' => 'https://casereports.bmj.com/content/2013/bcr-2012-007755'],
        ]);

        // Glutathione
        $this->createResearchLinks($glutathione->id, [
            ['title' => 'Glutathione: Master Antioxidant and Cellular Defense', 'authors' => 'Various Authors', 'journal' => 'ScienceDirect', 'publication_year' => 2023, 'article_url' => 'https://www.sciencedirect.com/science/article/pii/S0DMS-24423/18300378-8#61646'],
            ['title' => 'NIH PubMed: Glutathione Biology and Clinical Applications', 'authors' => 'Various Authors', 'journal' => 'NIH Gov/Articles', 'publication_year' => 2023, 'pubmed_id' => 'Pmc 9173531', 'article_url' => 'https://pmc.ncbi.nlm.nih.gov/articles/pmc9173531'],
            ['title' => 'WWW Research: Glutathione as Antioxidant Therapy', 'authors' => 'Various Authors', 'journal' => 'ResearchGate/Net', 'publication_year' => 2023, 'article_url' => 'https://www.researchgate.net/post/about-h-glutathione'],
            ['title' => 'E15 Med ORG: Clinical Applications of Glutathione', 'authors' => 'Various Authors', 'journal' => 'E15 Med ORG/Indexed', 'publication_year' => 2023, 'article_url' => 'https://e15med.org/indexed/article/net2/web'],
        ]);

        // NAD+
        $this->createResearchLinks($nad->id, [
            ['title' => 'NAD+ Metabolism and Cellular Function', 'authors' => 'Various Authors', 'journal' => 'OnlineLibrary Wiley', 'publication_year' => 2023, 'article_url' => 'https://onlinelibrary.wiley.com/doi/journal/10.1111/nep.7043'],
            ['title' => 'Nicotinamide Adenine Dinucleotide and Aging', 'authors' => 'Various Authors', 'journal' => 'ScienceDirect', 'publication_year' => 2023, 'article_url' => 'https://www.sciencedirect.com/science/article/pii/s0000-06291240180'],
            ['title' => 'NAD+ Supplementation for Longevity and Health', 'authors' => 'Various Authors', 'journal' => 'PubMed NCBI', 'publication_year' => 2023, 'pubmed_id' => 'Pmc 9512338', 'article_url' => 'https://pmc.ncbi.nlm.nih.gov/articles/pmc9512338'],
            ['title' => 'PLoS ONE: NAD+ Biology and Therapeutic Applications', 'authors' => 'Various Authors', 'journal' => 'JOURNALS.PLOS.ORG', 'publication_year' => 2023, 'article_url' => 'https://journals.plos.org/plosone/article?id=10.1371/journal.pone.2014237#53'],
        ]);
    }

    private function createResearchLinks(string $productId, array $links): void
    {
        CmsResearchLink::where('product_id', $productId)->delete();
        foreach ($links as $i => $link) {
            CmsResearchLink::create(array_merge([
    ...
    private function seedProductFaqs($semaglutide, $tirzepatide, $b12, $glutathione, $nad): void
    {
        CmsProductFaq::whereNotNull('product_id')->delete();

        $this->createFaqs($semaglutide->id, [
        ...
        $this->createFaqs($tirzepatide->id, [
        ...
        $this->createFaqs($glutathione->id, [
    ...
    private function createFaqs(string $productId, array $faqs): void
    {
        foreach ($faqs as $i => [$question, $answer]) {
            CmsProductFaq::updateOrCreate(
                ['question' => $question, 'product_id' => $productId],
                ['category' => 'product', 'answer' => $answer, 'display_order' => $i + 1, 'is_active' => true]
            );
        }
    }

    private function seedGeneralFaqs(): void
    {
        $generalFaqs = [
            ['How do I get started with FitByShot?', 'Getting started is simple! Complete our Telehealth form about your health and goals. Our medical team will review your information to determine your eligibility for treatment. Once approved, your customized prescription will be delivered right to your door.'],
            ['What treatments do you offer?', 'We offer three main categories of treatments: Weight Loss (Semaglutide and Tirzepatide for prescription weight loss), Wellness (B12 for energy and metabolism, Glutathione for immunity and detoxification), and Longevity (NAD+ therapy for cellular energy and healthy aging).'],
            ['How long until I see results?', 'Results vary by treatment. Weight loss treatments typically show results within 2-4 weeks. NAD+ therapy may provide immediate energy benefits, with long-term cellular benefits over 4-8 weeks. B12 energy improvements are often noticed within 24-48 hours. Glutathione benefits may be noticed within 2-4 weeks.'],
            ['Are these treatments safe?', 'Yes, all our treatments are administered under medical supervision. Our medical professionals review your health information and eligibility before prescribing any treatment. We provide ongoing support and monitoring throughout your wellness journey.'],
            ...
            ['What if I need to adjust my treatment?', 'Any subsequent orders will be reviewed in the context of your initial health and wellness goals. Our medical team monitors your progress and can adjust your treatment plan as needed to ensure optimal results. Contact us anytime if you have concerns or need modifications.'],
            ['Do I need a prescription for these treatments?', 'Yes, all our treatments require a prescription. After you complete our Telehealth form, our medical professionals will review your eligibility and prescribe the appropriate treatment based on your health goals and medical history.'],
            ['What makes FitByShot different?', 'FitByShot offers prescription weight loss, longevity, and wellness specific to your goals. We provide support for body, mind, and cellular health with treatments customized for your needs. Health is simplified and reliably delivered right to your door with ongoing medical oversight.'],
        ];

        foreach ($generalFaqs as $i => [$question, $answer]) {
            CmsProductFaq::updateOrCreate(
                ['question' => $question, 'product_id' => null],
                ['category' => 'general', 'answer' => $answer, 'display_order' => $i + 1, 'is_active' => true]
            );
        }
    }
}
